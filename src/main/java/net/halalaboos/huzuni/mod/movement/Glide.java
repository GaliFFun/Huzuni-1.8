...
public class Glide extends BasicMod {
	...
	public void onUpdate(UpdateEvent event) {
		if (mc.thePlayer.motionY <= -0.0315F && !mc.thePlayer.onGround && !mc.thePlayer.isInWater() && !mc.thePlayer.isOnLadder() && !mc.thePlayer.isInsideOfMaterial(Material.lava) && !mc.thePlayer.isCollidedVertically && event.type == Type.PRE) {
