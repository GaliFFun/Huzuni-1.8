...
public class ESP extends BasicMod implements Renderer {
	...
	public void render(float partialTicks) {
		for (Object o : mc.theWorld.loadedEntityList) {
			...
			if (entity == mc.thePlayer || entity.isDead || !MinecraftUtils.checkType(entity, invisibles.isEnabled(), mobs.isEnabled(), animals.isEnabled(), players.isEnabled()) || (properties.isEnabled() && !MinecraftUtils.checkProperties(entity)) || (checkAge.isEnabled() && !MinecraftUtils.checkAge(entity)))
				continue;
			...
			if (mode.getSelected() == 1) {
				...
				GlStateManager.pushMatrix();
				GlStateManager.translate(renderX, renderY, renderZ);
				GlStateManager.rotate(-mc.thePlayer.rotationYaw, 0F, 1F, 0F);
