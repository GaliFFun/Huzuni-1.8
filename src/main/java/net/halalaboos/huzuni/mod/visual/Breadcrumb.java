...
public class Breadcrumb extends BasicMod implements Renderer {
	...
	public void render(float partialTicks) {
		...
		if (lastPosition.distanceSq(mc.thePlayer.posX, mc.thePlayer.posY, mc.thePlayer.posZ) >= distance.getValue() && !Freecam.INSTANCE.isEnabled()) {
			lastPosition = new BlockPos(mc.thePlayer.posX, mc.thePlayer.posY, mc.thePlayer.posZ);
