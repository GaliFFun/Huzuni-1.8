	...
	public void onUpdate(UpdateEvent event) {
		if (event.type == UpdateEvent.Type.PRE) {
			if (huzuni.lookManager.hasPriority(this)) {
				...
				case 0:
					lookTask.setYaw(mc.thePlayer.rotationYaw);
					break;
				case 1:
				...
				case 2:
				    ...
				    lookTask.setYaw(mc.thePlayer.rotationYaw + yawPosition);
					break;
				}
				
				switch (modePitch.getSelected()) {
				case 0:
					lookTask.setPitch(mc.thePlayer.rotationPitch);
					break;
				case 1:
                ...
                case 3:
                    ...
                    lookTask.setPitch(mc.thePlayer.rotationPitch + pitchPosition);
                    break;
				}
