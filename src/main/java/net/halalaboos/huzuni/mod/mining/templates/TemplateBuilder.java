...
public class TemplateBuilder {
	...
	private final List<BlockPos> positions = new ArrayList<>(), previewPositions = new ArrayList<>();
	...
	public boolean addSelection(BlockPos position, EnumFacing face) {
		...
		if (selectedPositions != null && positionIndex >= template.getMaxPoints()) {
            positions.clear();
			template.generate(positions, Minecraft.getMinecraft().thePlayer.getHorizontalFacing(), selectedPositions);
	...
	public List<BlockPos> getPreview(BlockPos position, EnumFacing face) {
		...
		template.generate(previewPositions, Minecraft.getMinecraft().thePlayer.getHorizontalFacing(), tempPositions);
